...
function detectPatterns(candles, timeframe) {
  ...
  for (let i = 2; i < n; i++) {
    ...
    // ── Spinning Top ──────────────────────────────────────────────
    if (body < range * 0.25 && upperW > body * 0.5 && lowerW > body * 0.5) {
      results.push(pat(i, 'Spinning Top', 'neutral', 'continuation', 60, timeframe,
        'Small body, equal wicks. Indecision — trend likely continues.'));
      continue;
    }
  }
