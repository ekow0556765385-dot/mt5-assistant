...
// Reuse the same resolved values auth-middleware.js already uses
// successfully (with its fallback), instead of re-reading env vars
// that may be named/shaped differently on Railway (e.g. your
// combined `supabase_api_keys` variable).
const { SUPABASE_URL, SUPABASE_SERVICE } = require('./auth-middleware');
