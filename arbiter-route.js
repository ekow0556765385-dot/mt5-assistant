...
module.exports = function mountArbiter(app, deps) {
  ...
  app.get('/api/arbiter/habits', gate, async (req, res) => {
    try {
      ...
      res.json(Object.assign({ ok: true }, habitsSummary(eeps, t, first)));
    } catch (e) {
  ...
  async function factsFor(uid, kind, period) {
    ...
    return buildFacts(kind, period, attachLive(cls.data || [], jr || [], pos.data || []), eps.data || [], pos.data || [], jr || [], first);
  }
...
module.exports.habits = { habitsSummary, enrichEpisodes, HABIT, HABIT_LABELS, COUNTED };
