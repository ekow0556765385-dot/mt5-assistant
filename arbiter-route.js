...
const RULES = {
  ...
  // Detection window = the trader's own cooldown rule. The Assistant tab
  // detects at 900s while its own fix line advises a 30-minute cooldown, so
  // a re-entry at 20 minutes broke the rule and was never flagged. Arbiter
  // detects across the whole cooldown it is asking the trader to keep.
  REVENGE_WINDOW_S:  1800,   // re-entry within 30 min of a closed loss
