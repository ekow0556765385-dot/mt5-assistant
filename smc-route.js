// smc-route.js v2.2
// Fix: Removed inline express.json() from POST /smc and POST /smc/patterns.
//      Global express.json() in app.js already parses the body — the inline
//      parsers were consuming the stream a second time, emptying req.body.
...
// ── POST /smc ─────────────────────────────────────────────────────
// v2.2: removed inline express.json() — global middleware in app.js handles it
