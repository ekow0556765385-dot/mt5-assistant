...
const { getUserIdForLicenceKey, insertTrade, getTradesForUser, getMostRecentAccount, getAccountsForUser } = require('./journal-store');
...
app.post('/journal/trade', async (req, res) => {
  ...
  try {
    ...
    broadcast('journal_update', { ticket: trade.ticket, accountNumber: trade.accountNumber, symbol: trade.symbol, direction: trade.direction, totalPL: trade.totalPL, closeTime: trade.closeTime });
