...
// ── Auth middleware ────────────────────────────────────────────
const { requirePlan, requireAuth, getMe, validateKey, regenerateKey, cancelSubscription, issueTicketRoute, isOwner, getUserCredits, deductCredits, resetUserCredits, MONTHLY_CREDIT_USD, SUPABASE_URL, supabaseServiceHeaders, verifyAppSession, getUserIdForLicenceKey } = require('./auth-middleware');
