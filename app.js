...
// ── Auth middleware ────────────────────────────────────────────
const { requirePlan, requireFramedByDashboard, requireAuth, getMe, validateKey, regenerateKey, setBrokerType, cancelSubscription, issueTicketRoute, isOwner, getUserCredits, deductCredits, resetUserCredits, MONTHLY_CREDIT_USD, SUPABASE_URL, supabaseServiceHeaders, verifyAppSession, getUserIdForLicenceKey, resolveLicenceKey, getSourceForLicenceKey } = require('./auth-middleware');
