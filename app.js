...
// ── Admin console ─────────────────────────────────────────────
// Separate from user auth on purpose: its own cookie (bw-admin), its own
// gate (requireAdmin), and it never falls through to requireAuth or the
// owner bypass. Being signed in as a Blackwood user grants nothing here.
