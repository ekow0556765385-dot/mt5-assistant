...
async function updateSubscription(userId, planKey, paystackRef, legalMeta) {
...
router.get('/api/pay/callback', async (req, res) => {
  ...
  try {
    ...
    const result = await updateSubscription(userId, planKey, reference, legalMeta);
...
router.post('/api/pay/webhook', async (req, res) => {
  ...
  if (event.event === 'charge.success') {
    ...
    try {
      const result = await updateSubscription(userId, planKey, tx.reference, legalMeta);
