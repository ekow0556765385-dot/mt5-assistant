      ...
      <table width="100%" style="max-width:520px;background:#14141c;border:1px solid #22222e;border-radius:10px;overflow:hidden">
        ...
        <tr><td style="padding:32px 32px 0;text-align:center">
          <div style="display:inline-flex;align-items:center;gap:9px">
            <img src="https://blackwoodmt5.com/logo.png" alt="Blackwood" width="22" height="22" style="display:block">
            <span style="font-size:16px;font-weight:800;letter-spacing:.08em;color:#eceae0;text-transform:uppercase;line-height:1">Blackwood</span>
          </div>
        </tr></td>
